...
Write-Host ""
Write-Host "Updated 2022-10-20" -ForegroundColor DarkGreen2022-10-20
Write-Host ""
#endregion
...
Set-ItemProperty -LiteralPath "HKCR:\Directory\Shell\CMDMenu" -Name "(Default)" -Value "Open with Command Promp" -Force | Out-Null
