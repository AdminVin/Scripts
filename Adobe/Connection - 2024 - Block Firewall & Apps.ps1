...
# After Effects
netsh advfirewall firewall add rule name="Adobe - After Effects 2024" dir=in action=block program="C:\Program Files\Adobe\Adobe After Effects 2024\Support Files\AfterFX.exe" enable=yes
netsh advfirewall firewall add rule name="Adobe - After Effects 2024" dir=out action=block program="C:\Program Files\Adobe\Adobe After Effects 2024\Support Files\AfterFX.exe" enable=yes

# After Effects - Media Encoder
netsh advfirewall firewall add rule name="Adobe - After Effects - Media Encoder 2023" dir=in action=block program="C:\Program Files\Adobe\Adobe Media Encoder 2024\Adobe Media Encoder.exe" enable=yes
netsh advfirewall firewall add rule name="Adobe - After Effects - Media Encoder 2023" dir=out action=block program="C:\Program Files\Adobe\Adobe Media Encoder 2024\Adobe Media Encoder.exe" enable=yes
...
# Illustrator
netsh advfirewall firewall add rule name="Adobe - Illustrator 2024" dir=in action=block program="C:\Program Files\Adobe\Adobe Illustrator 2024\Support Files\Contents\Windows\Illustrator.exe" enable=yes
netsh advfirewall firewall add rule name="Adobe - Illustrator 2024" dir=out action=block program="C:\Program Files\Adobe\Adobe Illustrator 2024\Support Files\Contents\Windows\Illustrator.exe" enable=yes
...
# Photoshop
netsh advfirewall firewall add rule name="Adobe - Photoshop 2024" dir=in action=block program="C:\Program Files\Adobe\Adobe Photoshop 2024\Photoshop.exe" enable=yes
netsh advfirewall firewall add rule name="Adobe - Photoshop 2024" dir=out action=block program="C:\Program Files\Adobe\Adobe Photoshop 2024\Photoshop.exe" enable=yes

# Premiere
netsh advfirewall firewall add rule name="Adobe - Premiere 2024" dir=in action=block program="C:\Program Files\Adobe\Adobe Premiere Pro 2024\Adobe Premiere Pro.exe" enable=yes
netsh advfirewall firewall add rule name="Adobe - Premiere 2024" dir=out action=block program="C:\Program Files\Adobe\Adobe Premiere Pro 2024\Adobe Premiere Pro.exe" enable=yes
